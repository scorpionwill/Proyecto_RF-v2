...
# We assume this script is in /root/Proyecto_RF/prototipo_2.0/reconocimiento_facial/
sys.path.append(os.getcwd())
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'reconocimiento_facial.settings')
django.setup()

# Import services using top-level package names (since we are in the project root)
from usuarios.services.firebase_service import firebase_service
from usuarios.services.inspireface_service import inspireface_service

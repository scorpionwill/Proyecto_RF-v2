...
class FirebaseService:
    ...
    def initialize(self):
        ...
        try:
            ...
            cred_paths = [
                os.path.expanduser('~/firebase_credentials/serviceAccountKey.json'),
                os.path.expanduser('~/prototipo_2.0/firebase_credentials/serviceAccountKey.json'),
                '/home/scorpionwill/firebase_credentials/serviceAccountKey.json',
            ]
            ...
            if not cred_path:
                raise FileNotFoundError(
                    ...
                    "Colócalo en ~/firebase_credentials/serviceAccountKey.json"
                )

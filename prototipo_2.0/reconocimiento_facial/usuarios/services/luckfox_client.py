...
def send_image_to_luckfox(image_path_or_pil, timeout=30):
    ...
    Args:
        ...
        timeout: Tiempo de espera para respuesta del usuario (segundos)
    
    Returns:
        True si el usuario confirmó, False si rechazó o hubo timeout
    """
    ...
    try:
        ...
        # Enviar tamaño de imagen (4 bytes, little endian)
